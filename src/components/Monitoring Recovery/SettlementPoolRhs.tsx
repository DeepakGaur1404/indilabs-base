...
const SettlementPoolRhs = ({
  ...
  const graphData =
    selectedCategory === "all" && selectedActiveButton === "$Recovery"
      ...
      ? portfolioRecoveryGraphData?.Vintage.filter(
          (item: SubCategories) => item[1].segment === "V1"
        ).map((item: any) => ({
          month: item[1].month,
          recovery: item[1].recovery,
          "Recovery_%": item[1]["Recovery_%"] * 100,
      ...
      : selectedSubCategories === "V2" &&
        ...
        selectedActiveButton === "$Recovery"
      ? portfolioRecoveryGraphData?.Vintage.filter(
          (item: SubCategories) => item[1].segment === "V2"
        ).map((item: any) => ({
          month: item[1].month,
          recovery: item[1].recovery,
          "Recovery_%": item[1]["Recovery_%"] * 100,
      ...
      : selectedSubCategories === "V3" &&
        ...
        selectedActiveButton === "$Recovery"
      ? portfolioRecoveryGraphData?.Vintage.filter(
          (item: SubCategories) => item[1].segment === "V3"
        ).map((item: any) => ({
          month: item[1].month,
          recovery: item[1].recovery,
          "Recovery_%": item[1]["Recovery_%"] * 100,
      ...
      : selectedSubCategories === "V4" &&
        ...
        selectedActiveButton === "$Recovery"
      ? portfolioRecoveryGraphData?.Vintage.filter(
          (item: SubCategories) => item[1].segment === "V4"
        ).map((item: any) => ({
          month: item[1].month,
          recovery: item[1].recovery,
          "Recovery_%": item[1]["Recovery_%"] * 100,
      ...
      : selectedSubCategories === "V5" &&
        ...
        selectedActiveButton === "$Recovery"
      ? portfolioRecoveryGraphData?.Vintage.filter(
          (item: SubCategories) => item[1].segment === "V5"
        ).map((item: any) => ({
          month: item[1].month,
          recovery: item[1].recovery,
          "Recovery_%": item[1]["Recovery_%"] * 100,
      ...
      : selectedSubCategories === "V6" &&
        ...
        selectedActiveButton === "$Recovery"
      ? portfolioRecoveryGraphData?.Vintage.filter(
          (item: SubCategories) => item[1].segment === "V6"
        ).map((item: any) => ({
          month: item[1].month,
          recovery: item[1].recovery,
          "Recovery_%": item[1]["Recovery_%"] * 100,
      ...
      : selectedSubCategories === "V7" &&
        ...
        selectedActiveButton === "$Recovery"
      ? portfolioRecoveryGraphData?.Vintage.filter(
          (item: SubCategories) => item[1].segment === "V7"
        ).map((item: any) => ({
          month: item[1].month,
          recovery: item[1].recovery,
          "Recovery_%": item[1]["Recovery_%"] * 100,
      ...
      ? portfolioRecoveryGraphData?.location
          .filter((item: SubCategories) => item[1].segment === "UTTAR PRADESH")
          .map((item: any) => ({
            month: item[1].month,
            recovery: item[1].recovery,
            "Recovery_%": item[1]["Recovery_%"] * 100,
      ...
      : selectedSubCategoriesLocation === "MAHARASHTRA" &&
        ...
        selectedActiveButton === "$Recovery"
      ? portfolioRecoveryGraphData?.location
          .filter((item: SubCategories) => item[1].segment === "MAHARASHTRA")
          .map((item: any) => ({
            month: item[1].month,
            recovery: item[1].recovery,
            "Recovery_%": item[1]["Recovery_%"] * 100,
      ...
      : selectedSubCategoriesLocation === "TAMIL NADU" &&
        ...
        selectedActiveButton === "$Recovery"
      ? portfolioRecoveryGraphData?.location
          .filter((item: SubCategories) => item[1].segment === "TAMIL NADU")
          .map((item: any) => ({
            month: item[1].month,
            recovery: item[1].recovery,
            "Recovery_%": item[1]["Recovery_%"] * 100,
      ...
      : selectedSubCategoriesLocation === "MADHYA PRADESH" &&
        ...
        selectedActiveButton === "$Recovery"
      ? portfolioRecoveryGraphData?.location
          .filter((item: SubCategories) => item[1].segment === "MADHYA PRADESH")
          .map((item: any) => ({
            month: item[1].month,
            recovery: item[1].recovery,
            "Recovery_%": item[1]["Recovery_%"] * 100,
  ...
  const uniqueGraphData =
    selectedCategory === "all" && selectedActiveButton === "uniquePayer"
      ...
      //   selectedActiveButton === "uniquePayer"
      // ? portfolioRecoveryUniquePayerGraphData?.mob
      //     .filter((item: SubCategories) => item[0].segment === "24-36")
      //     .map((item: any) => ({
      //       month: item[0].month,
      ...
      //   selectedActiveButton === "uniquePayer"
      // ? portfolioRecoveryUniquePayerGraphData?.mob
      //     .filter((item: SubCategories) => item[0].segment === "36+")
      //     .map((item: any) => ({
      //       month: item[0].month,
      //       active_recovery_balance: item[0].active_recovery_balance,
      //       recovery: item[0].recovery,
      ...
      //     .filter((item: SubCategories) => item[0].segment === "1")
      //     .map((item: any) => ({
      //       month: item[0].month,
      //       active_recovery_balance: item[0].active_recovery_balance,
      //       recovery: item[0].recovery,
      ...
      //   selectedActiveButton === "uniquePayer"
      // ? portfolioRecoveryUniquePayerGraphData?.placement
      //     .filter((item: SubCategories) => item[0].segment === "2")
      //     .map((item: any) => ({
      //       month: item[0].month,
      //       active_recovery_balance: item[0].active_recovery_balance,
      //       recovery: item[0].recovery,
      ...
      //   selectedActiveButton === "uniquePayer"
      // ? portfolioRecoveryUniquePayerGraphData?.placement
      //     .filter((item: SubCategories) => item[0].segment === "3")
      //     .map((item: any) => ({
      //       month: item[0].month,
      //       active_recovery_balance: item[0].active_recovery_balance,
      //       recovery: item[0].recovery,
      ...
      //   selectedActiveButton === "uniquePayer"
      // ? portfolioRecoveryUniquePayerGraphData?.placement
      //     .filter((item: SubCategories) => item[0].segment === "4")
      //     .map((item: any) => ({
      //       month: item[0].month,
      //       active_recovery_balance: item[0].active_recovery_balance,
      //       recovery: item[0].recovery,
      ...
      //   selectedActiveButton === "uniquePayer"
      // ? portfolioRecoveryUniquePayerGraphData?.placement
      //     .filter((item: SubCategories) => item[0].segment === "5")
      //     .map((item: any) => ({
      //       month: item[0].month,
      //       active_recovery_balance: item[0].active_recovery_balance,
      //       recovery: item[0].recovery,
      ...
      //   selectedActiveButton === "uniquePayer"
      // ? portfolioRecoveryUniquePayerGraphData?.placement
      //     .filter((item: SubCategories) => item[0].segment === "6+")
      //     .map((item: any) => ({
      //       month: item[0].month,
      //       active_recovery_balance: item[0].active_recovery_balance,
      //       recovery: item[0].recovery,
      ...
      //     .filter((item: SubCategories) => item[0].segment === "20-25L")
      //     .map((item: any) => ({
      //       month: item[0].month,
      ...
      //   selectedActiveButton === "uniquePayer"
      // ? portfolioRecoveryUniquePayerGraphData?.pos
      //     .filter((item: SubCategories) => item[0].segment === "20L+")
      //     .map((item: any) => ({
      //       month: item[0].month,
      //       active_recovery_accounts: item[0].active_recovery_accounts,
      //       "%Unique_payers": item[0]["%Unique_payers"],
      ...
      ? portfolioRecoveryUniquePayerGraphData?.agency
          .filter((item: SubCategories) => item[0].segment === "Very Small")
          .map((item: any) => {
            const newItem: {
              month: any;
      ...
      : selectedSubCategoriesAgency === "Small" &&
        ...
        selectedActiveButton === "uniquePayer"
      ? portfolioRecoveryUniquePayerGraphData?.agency
          .filter((item: SubCategories) => item[0].segment === "Small")
          .map((item: any) => {
            const newItem: {
              month: any;
              active_recovery_accounts: any;
      ...
      : selectedSubCategoriesAgency === "Medium" &&
        ...
        selectedActiveButton === "uniquePayer"
      ? portfolioRecoveryUniquePayerGraphData?.agency
          .filter((item: SubCategories) => item[0].segment === "Medium")
          .map((item: any) => {
            const newItem: {
              month: any;
              active_recovery_accounts: any;
      ...
      : selectedSubCategoriesAgency === "Large" &&
        ...
        selectedActiveButton === "uniquePayer" &&
        portfolioRecoveryUniquePayerGraphData?.agency
          .filter((item: SubCategories) => item[0].segment === "Large")
          .map((item: any) => {
            const newItem: {
              month: any;
              active_recovery_accounts: any;
