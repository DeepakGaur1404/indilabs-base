...
const value = (jsondata.balance.fytd_recovery || 0) / 1000000;
...
const DiagnosticInsightandvalidationHeader = (props: Props) => {
  const formattedDate = () => {
    const date = new Date();
            ...
            >
              ...
              <div className="flex-col justify-start items-start gap-1 inline-flex customClassMonitoringDashboardHeader">
                ...
                <div className="text-[#000000] text-[16px] font-[400] font-['DM Sans'] tracking-wide">
                  {data.name === "total_pos"
                    ? `₹${((balanceData?.total_pos || 0) / 1000000).toFixed(1)} M`
                    : data.name === "fytd_recovery"
                    ? `₹${truncatedValue} M`
...
export default DiagnosticInsightandvalidationHeader;
