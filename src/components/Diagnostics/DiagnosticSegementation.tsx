import {
  ...
  const datakeyAccounts: DataItem[] = [
    { name: "Low Payer", percentage: 23 },
    { name: "High / Medium Payer", percentage: 77 },
  ];
  
  const datakeyBalances: DataItem[] = [
    { name: "Low Payer", percentage: 40 },
    { name: "High / Medium Payer", percentage: 60 },
  ];
  
  const bardata = [
    { name: "Low Payer", percentage: 6, fill: "#fcb400" },
    { name: "High / Medium Payer", percentage: 17, fill: "#4c74e6" },
  ];
